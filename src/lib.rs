...
//!
//! * `clients/client`: an asynchronous Redis client implementation.
//!   Demonstrates how to build clients with Tokio.
//!
...
pub mod clients;
pub use clients::{BlockingClient, BufferedClient, Client, SessionClient};
...
/// A specialized `Result` type for db-rs operations.
///
